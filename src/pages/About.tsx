        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="flex flex-col items-center lg:items-start gap-6">
            ...
            <div className="flex flex-col gap-3 w-full">
              <a href="/downloads/Michael_Riddiough_Resume.docx" download className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-5 py-3 rounded font-semibold text-sm hover:opacity-90 transition-opacity">
                <Download size={16} /> Franchise Resume
              </a>
              <a href="/downloads/My_Clinical_Pharmacy_Career.docx" download className="flex items-center justify-center gap-2 border-2 border-primary text-primary px-5 py-3 rounded font-semibold text-sm hover:bg-primary hover:text-primary-foreground transition-colors">
