          ...
          <div className="card-executive flex flex-col justify-center">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex gap-2">
                ...
                <span><strong className="text-foreground">Franchisors</strong> seeking to accelerate unit growth and sales</span>
              </li>
              <li className="flex gap-2">
                <span className="text-gold font-bold">→</span>
                <span><strong className="text-foreground">Boards & Advisory Groups</strong> looking for franchise industry expertise</span>
              </li>
              <li className="flex gap-2">
                <span className="text-gold font-bold">→</span>
                <span><strong className="text-foreground">Investors</strong> evaluating franchise opportunities</span>
              </li>
              <li className="flex gap-2">
                <span className="text-gold font-bold">→</span>
                <span><strong className="text-foreground">Conference Organizers</strong> seeking an experienced franchise speaker</span>
              </li>
              <li className="flex gap-2">
                <span className="text-gold font-bold">→</span>
                <span><strong className="text-foreground">Recruiters</strong> with executive-level franchise roles</span>
              </li>
            </ul>
